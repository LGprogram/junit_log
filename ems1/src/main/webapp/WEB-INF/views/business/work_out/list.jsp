        ...
        <section class="content">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">劳务外包合同列表</h3>
    ...
    $(function () {
        var table= $(".table").DataTable({
            ...
            "columns":[
                {"data":"id","name":"id"},
                {"data":function (row) {
                        return"<a href='/page/workout/show/"+row.serialNum+"'>"+row.serialNum+"</a>"
        ...
        $(document).delegate(".checkBtn","click",function () {
            ...
            layer.confirm("确定要将合同修改为完成吗？",function (index) {
                $.post("/page/workout/in",{"id":id}).done(function (resp) {
