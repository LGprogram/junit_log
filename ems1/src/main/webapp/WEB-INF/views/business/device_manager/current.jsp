...
<div class="wrapper">
    ...
    <jsp:include page="../../include/asider.jsp">
        <jsp:param name="menu" value="sys_current"/>
    </jsp:include>
            ...
            <div class="box box-solid box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="/page/device/new" class="btn"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="box-body">
    ...
    $(function () {
        ...
        $(document).delegate('.deleteLink','click',function () {
            if(confirm("确定要删除吗？")){
                ...
                $.get("/page/device/"+id+"/del").done(function (data) {
                    if(data == "success"){
                        alert("删除成功");
                        //dataTables重新加载
                        table.ajax.reload();
