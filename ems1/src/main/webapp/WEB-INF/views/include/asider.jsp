                ...
                <li class="treeview ${fn:startsWith(param.menu,'sys_') ? 'active' : ''}">
                    ...
                    <ul class="treeview-menu">
                        <li class="${param.menu == 'sys_day' ? 'active' : ''}">
                            <a href="/page/france/day"><i class="fa fa-circle-o"></i> 日报</a>
                        </li>
                        <li class="${param.menu == 'sys_month' ? 'active' : ''}">
                            <a href="/page/france/month"><i class="fa fa-circle-o"></i> 月报</a>
                        </li>
                        <li class="${param.menu == 'sys_year' ? 'active' : ''}">
                            <a href="/page/france/year"><i class="fa fa-circle-o"></i> 年报</a>
                        </li>
                    </ul>
                </li>
            </shiro:hasRole>
                        ...
                        <li class="${fn:startsWith(param.menu,'sys_') ? 'active' : ''}">
                            ...
                            <ul class="treeview-menu">
                                <li class="${param.menu == 'sys_work_out' ? 'active' : ''}">
                                    <a href="/page/workout/out"><i class="fa fa-circle-o"></i> 业务流水</a>
                                </li>
                                <li class="${param.menu == 'sys_work_add' ? 'active' : ''}">
                                    <a href="/page/workout/add"><i class="fa fa-plus"></i> 新增流水 <i class="fa fa-angle-left pull-right"></i></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
