    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    <div id="yearforEchart" style="width:auto;height:800px;"></div>
                </div>
            </div>
        </section>
        <!-- /.content -->
...
<script>
    $(function () {
        ...
        var yearChartLoad = function () {
            var yearChart = echarts.init(document.getElementById('yearforEchart'));
            var days=[];    //
            var incomes=[];    //
            var expends=[];
            var year = $("#year").val();
            ...
            $.ajax({
                ...
                url : "/page/france/echarts/year/load",
                data : {"year":year},
        ...
        var table = $(".table").DataTable({
            ...
            "columns":[
                ...
                {"data":"remark"},
                {"data":function (row) {
                    return"<a href='/page/france/month/"+row.date+"/detail'>详情</a>";
                }}
