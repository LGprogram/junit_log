...
<div class="wrapper">
    ...
    <jsp:include page="../include/asider.jsp">
        <jsp:param name="menu" value="sys_manager"/>
    </jsp:include>
            ...
            <div class="box box-solid box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="/page/user/new" class="btn"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${page.items}" var="user">
                            <tr>
                                ...
                                <td>
                                    <a href="/page/user/${user.id}/edit">修改</a>|
                                    <a href="/page/user/${user.id}/del">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    $(function () {
        ...
        $("#pagination").twbsPagination({
            ...
            visiblePages:5,
            href:"/page/user?q_name=${q_name}&q_role=${q_role}&p={{number}}",
            first:"首页",
            prev:"上一页",
            next:"下一页",
            last:"末页"
